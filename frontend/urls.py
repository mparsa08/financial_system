...
from .views import AddClosedTradeView, DashboardView, DepositView, WithdrawView, TradeView, TradeBuyView, TradeSellView, HistoryView, LoginView, logout_view, CreateTradingAccountView, ChartOfAccountsView, IncomeStatementView, DeleteTradingAccountView, CalculateUnrealizedPnLView, TransferFundsView
