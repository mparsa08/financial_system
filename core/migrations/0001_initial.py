...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ClosedTradesLog',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trade_date', models.DateField()),
                ('net_profit_or_loss', models.DecimalField(decimal_places=2, max_digits=10)),
                ...
                ('trading_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.tradingaccount')),
            ],
        ),
        migrations.AddField(
